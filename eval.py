...
def main():
    ...
    # Path tags matching training directory layout
    parser.add_argument('--alpha_input', type=str, default='none',
                        help='Ablation tag for alpha input; used for folder naming')
    parser.add_argument('--alpha_apply_mode', type=str, default='none',
                        help='Ablation tag for atom update; used for folder naming')
    ...
    parser.add_argument('--pt_file', type=str, default='epoch_123.pt', help='Name of PT file')
    ...
    checkpoint = torch.load(os.path.join(exp_dir, f'{args.pt_file}'), 
