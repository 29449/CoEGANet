...
def preprocessing(rxns: List, args: Any, rxn_classes: List = [], rxns_id=[]) -> None:
    ...
    savedir = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/{args.mode}'
    ...
    if args.mode == 'train':
        ...
        bond_vocab_file = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/train/bond_vocab.txt'
        atom_vocab_file = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/train/atom_lg_vocab.txt'
...
def main():
    ...
    datadir = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/'
