...
def process_batch(batch_graphs, args):
    ...
    bond_vocab_file = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/{args.mode}/bond_vocab.txt'
    atom_vocab_file = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/{args.mode}/atom_lg_vocab.txt'
...
def prepare_data(args: Any) -> None:
    ...
    """
    datafile = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/{args.mode}/{args.mode}.file.kekulized'
    ...
    if args.use_rxn_class:
        savedir = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/{args.mode}/with_rxn_class/'
    else:
        savedir = f'/data/Students/Wen-Hao/Zhang-Chao/Graph2Edits-master/data/{args.dataset}/{args.mode}/without_rxn_class/'
